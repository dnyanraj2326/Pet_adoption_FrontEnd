import {
    ...
    return (
      <View style={styles.container}>
        <View style={{marginTop: moderateScale(30)}}>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.stepSection}>
              ...
              <Text style={styles.stepNumStyle}>3/3</Text>
            </View>
        ...
        <View
          ...
          <TouchableOpacity activeOpacity={0.7} style={styles.nextBtn} onPress={() => navigation.navigate("BottomNav")}>
  ...
  export default UserInfoDetail3;
