        ...
        <Animatable.View
          ...
          <TouchableOpacity
            ...
            <View style={styles.imgSection}>
              <Image source={{uri: petUrl[0]}} style={styles.img} />
            </View>
            <View style={styles.textContent}>
              <View style={styles.nameWithGender}>
                ...
                <Image
                  source={
                    gender == 'Male'
                      ? require('../assets/icon/maleIcon.png')
                      : require('../assets/icon/femaleIcon.png')
                  }
                  style={styles.genderIcon}
                />
              </View>
              <Text style={styles.age}>{petAge} years old</Text>
              <View style={styles.distance}>
                ...
                <Text style={styles.locationValue}>{distance}</Text>
              </View>
            </View>
          </TouchableOpacity>
        </Animatable.View>
